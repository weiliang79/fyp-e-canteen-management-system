...
class StudentLoginController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if ($this->attemptLogin($request)) {
            if ($request->hasSession()) {
                $request->session()->put('auth.password_confirm_at', time());
            }
    ...
    {
        return redirect()->route('landing')->with('swal-success', 'Login successful.');
    }
    ...
    {
        return redirect()->route('student.login')->with('swal-success', 'Logout Successful.');
    }
}
