    ...
    <div class="row justify-content-center">
        <div class="col">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            ...
                            <img src="{{ asset('storage/defaults/Stripe_Logo/Stripe wordmark - blurple (small).png') }}" alt="Stripe Logo" style="width: 30%;">

                            <p class="mb-4 ms-4">{{ \App\Models\PaymentType::find(\App\Models\PaymentType::PAYMENT_STRIPE)->description }}</p>
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ __('The card holder name field is required.') }}</strong>
                                            </span>
                                        </div>
                                    </div>
                                </div>
            ...
            <small class="d-flex justify-content-center">
                {{ __('Powered by Stripe, Inc and Stripe JS.') }}
            </small>
        </div>
    </div>
</div>
