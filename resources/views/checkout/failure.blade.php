                        ...
                        <div class="card-body">
                              ...
                              <div class="row my-4">
                                    <div class="col text-danger text-center">
                                          <i class="fa-solid fa-circle-exclamation fa-lg"></i> The Payment has occurred error during transaction.
                                    </div>
                              </div>

                              <div class="row my-4">
                                    <div class="col text-center">
                                          <p class="mb-1">Please contact system administrator if the error reappears multiple times.</p>
