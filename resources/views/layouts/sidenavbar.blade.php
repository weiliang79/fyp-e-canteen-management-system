      ...
      <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item dropdown">
                  ...
                  <div class="collapse {{ Illuminate\Support\Str::startsWith(Route::currentRouteName(), 'admin.menus') ? 'show' : '' }}" id="menu-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                              <li>
                                    <a class="nav-link {{ Illuminate\Support\Str::startsWith(Route::currentRouteName(), 'admin.menus.category') ? 'active' : 'link-dark' }} mx-4" href="{{ route('admin.menus.category') }}">{{ __('Product Category') }}</a>
                              </li>
                              <li>
                                    <a class="nav-link {{ Illuminate\Support\Str::startsWith(Route::currentRouteName(), 'admin.menus.list') ? 'active' : 'link-dark' }} mx-4" href="{{ route('admin.menus.list') }}">{{ __('Product List') }}</a>
                              </li>
                        </ul>
                  </div>
            </li>
            ...
            <li class="nav-item dropdown">
                  ...
                  <div class="collapse {{ Illuminate\Support\Str::startsWith(Route::currentRouteName(), 'admin.payment') ? 'show' : '' }}" id="payment-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                              <li>
                                    <a class="nav-link {{ Illuminate\Support\Str::startsWith(Route::currentRouteName(), 'admin.payment.general') ? 'active' : 'link-dark' }} mx-4" href="{{ route('admin.payment.general') }}">{{ __('General') }}</a>
                              </li>
                              @if(config('payment.2c2p-status'))
                              <li>
                                    <a class="nav-link {{ Illuminate\Support\Str::startsWith(Route::currentRouteName(), 'admin.payment.2c2p') ? 'active' : 'link-dark' }} mx-4" href="{{ route('admin.payment.2c2p') }}">{{ __('2C2P') }}</a>
                              </li>
                              @endif
                              @if(config('payment.stripe-status'))
                              <li>
                                    <a class="nav-link {{ Illuminate\Support\Str::startsWith(Route::currentRouteName(), 'admin.payment.stripe') ? 'active' : 'link-dark' }} mx-4" href="{{ route('admin.payment.stripe') }}">{{ __('Stripe') }}</a>
                              </li>
                              @endif
                        </ul>
                  </div>
            ...
            <li class="nav-item dropdown">
                  ...
                  <div class="collapse {{ Illuminate\Support\Str::startsWith(Route::currentRouteName(), 'admin.design') ? 'show' : '' }}" id="design-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                              <li>
                                    <a class="nav-link {{ Illuminate\Support\Str::startsWith(Route::currentRouteName(), 'admin.design.general') ? 'active' : 'link-dark' }} mx-4" href="{{ route('admin.design.general') }}">{{ __('General') }}</a>
                              </li>
                              <li>
                                    <a class="nav-link {{ Illuminate\Support\Str::startsWith(Route::currentRouteName(), 'admin.design.landing') ? 'active' : 'link-dark' }} mx-4" href="{{ route('admin.design.landing') }}">{{ __('Landing Page') }}</a>
                              </li>
                              <li>
                                    <a class="nav-link {{ Illuminate\Support\Str::startsWith(Route::currentRouteName(), 'admin.design.information') ? 'active' : 'link-dark' }} mx-4" href="{{ route('admin.design.information') }}">{{ __('Information Page') }}</a>
                              </li>
                        </ul>
                  </div>
            </li>
