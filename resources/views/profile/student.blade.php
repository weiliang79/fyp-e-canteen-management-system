                        ...
                        <div class="col">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{ old('first_name', auth()->guard('student')->user()->first_name) }}">
                                                    <input type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" value="{{ old('last_name', auth()->guard('student')->user()->last_name) }}">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone', auth()->guard('student')->user()->phone) }}" placeholder="Phone">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address', auth()->guard('student')->user()->address) }}" placeholder="Address">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('student.profile.update_email') }}" onkeydown="return event.key != 'Enter';">
                                        @csrf

                                        <div class="row mb-3">
                                            <label for="" class="col-md-3 col-form-label text-md-end">{{ __('Email Address') }}</label>
                                            ...
                                            <div class="col-md-8">
                                                <div id="email_group" class="input-group">
                                                    ...
                                                    <input type="text" class="form-control @error('email') is-invalid @enderror" name="email" id="email_field" placeholder="Email Address" value="{{ old('email', auth()->guard('student')->user()->email) }}">
                                                    <button type="button" class="btn btn-primary" onclick="sendVerifyEmail();">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('student.profile.update_password') }}" method="post">
                                        ...
                                        <div class="row mb-3">
                                            <label for="" class="col-md-3 col-form-label text-md-end">{{ __('New Password') }}</label>
                                        ...
                                        <div class="row mb-3">
                                            <label for="" class="col-md-3 col-form-label text-md-end">{{ __('Confirm Password') }}</label>
...
<template id="code_template">
    <div id="code_input">
        <div class="row mb-3">
            <label for="" class="col-md-3 col-form-label text-md-end">{{ __('Verification Code') }}</label>
